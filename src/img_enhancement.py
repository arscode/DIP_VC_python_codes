...
def basicLinearTransform():
    ...
    #cv.namedWindow('Brightness and contrast adjustments', cv.WINDOW_NORMAL)
...
cv.namedWindow('Brightness and contrast adjustments', cv.WINDOW_NORMAL)
#cv.resizeWindow('Brightness and contrast adjustments', 640, 300)
cv.namedWindow('Gamma correction', cv.WINDOW_NORMAL)
